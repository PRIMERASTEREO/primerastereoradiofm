...
const URL_STREAMING = 'https://stream.zeno.fm/u6cbawcdkcxvv';
...
const url = 'https://api.zeno.fm/mounts/metadata/subscribe/u6cbawcdkcxvv';
...
window.onload = function () {
    ...
    coverArt.style.height = coverArt.offsetWidth + '50px';
